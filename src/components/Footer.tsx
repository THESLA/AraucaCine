  ...
  return (
    <footer className="border-t border-border py-10 px-4 shadow-inner shadow-black/5">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-6 pt-6 pb-4 border-t border-border">
          <a href="https://git-scm.com" target="_blank" rel="noopener" className="flex items-center gap-1.5 text-xs text-muted hover:text-accent transition-colors no-underline" title="Git">
            <GitLogo />
            <span>Git</span>
          </a>
          <a href="https://opencode.ai" target="_blank" rel="noopener" className="flex items-center gap-1.5 text-xs text-muted hover:text-accent transition-colors no-underline" title="opencode">
            <OpenCodeLogo />
            <span>opencode</span>
          </a>
          <a href="https://html.spec.whatwg.org" target="_blank" rel="noopener" className="flex items-center gap-1.5 text-xs text-muted hover:text-accent transition-colors no-underline" title="HTML5">
            <Html5Logo />
            <span>HTML5</span>
          </a>
        </div>
