  ...
  return (
    <section id="nosotros" className="py-24 px-4">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-muted text-base md:text-lg max-w-3xl mx-auto mb-16 leading-relaxed text-justify">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {items.map(i => (
            <Card key={i.title} className="p-8 text-left hover:border-accent/30 transition-colors">
              ...
              <p className="text-muted text-sm leading-relaxed text-justify">{i.text}</p>
            </Card>
          ))}
        </div>
      </div>
